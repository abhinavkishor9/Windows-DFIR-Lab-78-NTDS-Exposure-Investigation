...
## 11. Important Investigation Boundary

This lab intentionally did not perform:
...
- Artificial creation of an NTDS database

The investigation focused on forensic evidence surrounding the potential artifact rather than obtaining credential material.

---

## Troubleshooting Principle

When a forensic artifact is missing, the answer is not to manufacture the artifact.
...
Validate the environment
        ↓
Check whether the artifact is expected
        ↓
...
This produces a more defensible investigation than forcing a positive result.
